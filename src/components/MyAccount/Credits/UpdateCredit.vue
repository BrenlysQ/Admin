        ...
        <div class="ui-margin-large-bottom">
            ...
            <div class="detailed_debt">
                <div class="ui-row">
                    <div class="ui-column-6">
                        <div class="ui-input-group">
                            ...
                            id="'currency"
                            class="ui-input firstname"
                            v-model="currency_selected.name"
                            disabled>
                        </div>
                    </div>
                ...
                <div class="ui-row">
                    ...
                    <button class="ui-button ui-button--secondary" @click="updateCredit">Actualizar Crédito</button>
                </div>
            </div>
        </div>
    </div>
...
<script src="./UpdateCredit.js"></script>
